      ...
      <DialogContent className="max-w-md">
        <DialogHeader>
          <div className="flex flex-col items-center mb-2">
            <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-emerald-600 shadow-md shadow-emerald-600/20 mb-3">
        ...
        <div className="space-y-3">
          ...
          <Button
            className="w-full h-11 bg-emerald-600 hover:bg-emerald-700 shadow-sm shadow-emerald-600/20"
